...
@	compiled by GNU C version 4.6.3, GMP version 6.0.0, MPFR version 3.1.2, MPC version 1.0.2
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc -I include -I ../include
@ -I ../arch/arm/include -I ../. -I .
@ -isysroot /second_extend/yocto_file/new_fsl_bsp/build/tmp/sysroots/imx6qsabresd
@ -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x17800000 -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /second_extend/yocto_file/new_fsl_bsp/build/tmp/sysroots/i686-linux/usr/lib/arm-poky-linux-gnueabi/gcc/arm-poky-linux-gnueabi/4.9.2/include
...
@ -mfloat-abi=soft -march=armv7-a -mtls-dialect=gnu
...
.LASF58:
	.ascii	"/second_extend/yocto_file/new_fsl_bsp/build/tmp/wor"
	.ascii	"k/imx6qsabresd-poky-linux-gnueabi/u-boot-imx/2015.0"
	.ascii	"4-r0/git/mx6qsabresd_config\000"
.LASF33:
